...
export default function Portfolio() {
  ...
  return (
    <section id="portfolio" className="py-24 bg-[#FAF8F4] relative border-t border-[#E2DDD5]/60 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="mb-16 flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          <div>
            <span className="font-sans text-xs tracking-[0.35em] uppercase text-gold font-semibold mb-3 block">
              Editorial Selected Works
            </span>
            <h2 className="font-serif text-4xl md:text-5xl font-light text-charcoal tracking-tight">
              Crafted Homes <span className="font-serif italic text-gold font-normal">& Renovated Spaces</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 xl:gap-16 items-start">
          ...
          <div className="lg:col-span-4 space-y-4">
            <span className="font-sans text-[10px] tracking-widest text-[#B8965A] font-semibold uppercase block mb-6">
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left pl-6 py-5.5 transition-all duration-300 relative focus:outline-none block group ${
                      isActive 
                        ? "text-charcoal font-medium bg-[#F5F0E8]/50 border-l-2 border-gold -ml-px" 
                        : "text-muted hover:text-charcoal border-l border-transparent hover:bg-[#F5F0E8]/20 -ml-px"
                    }`}
                  >
                    <div className="flex flex-col text-left">
                      <span className="font-sans text-[9px] tracking-wider uppercase text-gold pointer-events-none mb-1">
                        {project.category}
                      </span>
                    ...
                    <ArrowRight className={`w-4 h-4 text-gold absolute right-4 top-1/2 -translate-y-1/2 transition-all duration-300 ${
            ...
            <div className="pt-6">
              <a
                ...
                className="inline-flex items-center gap-2.5 font-sans text-xs tracking-widest text-charcoal hover:text-gold uppercase font-semibold transition-colors duration-300 py-2 group"
              >
                <Instagram className="w-4 h-4" /> Live Projects on Instagram <ArrowUpRight className="w-4 h-4 text-gold group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
              </a>
            </div>
          </div>
                ...
                <div className="p-8 md:p-10 space-y-8">
                  ...
                  <div className="pb-6 border-b border-[#E2DDD5]/60">
                    <h4 className="font-serif text-lg font-medium text-charcoal mb-4 flex items-center gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-gold" /> Spatial Transformation
                    </h4>
                    
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
                      {/* Before column */}
                      <div className="bg-[#FAF8F4] p-4 border-l border-[#B8965A]/40 md:border-l-2">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 pt-2">
                    <div className="space-y-1.5 flex-1">
                      <div className="flex items-center gap-2 text-[#FAF8F4] bg-[#B8965A] px-3 py-1 font-sans text-[9px] tracking-widest uppercase font-semibold w-fit">
